...
var a = globalThis.document?.documentElement;
function r() {
  const n = a?.getAttribute("lang"), e3 = globalThis.navigator?.language;
  return o ?? n ?? e3 ?? "en";
}
function l() {
...
if (globalThis.addEventListener?.("languagechange", x), a) {
...
//# sourceMappingURL=chunk-YY5PITIH.js.map
