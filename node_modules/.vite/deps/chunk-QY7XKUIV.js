...
function p(t3, n4) {
  ...
  if (b(t3)) {
    ...
    const r5 = t3.map((t4) => {
      const r6 = p(t4, n4);
      return null != t4 && null == r6 && (e6 = false), r6;
    });
    return e6 ? r5 : null;
  }
  if (y(t3)) return t3.clone(n4);
  if (t3 instanceof File || t3 instanceof Blob) return t3;
  if (m(t3)) return null;
  const r4 = new (0, Object.getPrototypeOf(t3).constructor)();
  for (const o5 of Object.getOwnPropertyNames(t3)) {
    const n5 = t3[o5], e6 = p(n5);
    if (null != n5 && null == e6) return null;
    r4[o5] = e6;
  }
  return r4;
}
...
function f2(n4, t3, e5) {
  return t3 ? Object.keys(t3).reduce((n5, i4) => {
    ...
    let u4 = n5[i4], o5 = t3[i4];
    return u4 === o5 ? n5 : void 0 === u4 ? (n5[i4] = a2(o5), n5) : (Array.isArray(o5) || Array.isArray(n5) ? (u4 = u4 ? Array.isArray(u4) ? n5[i4] = u4.slice() : n5[i4] = [u4] : n5[i4] = [], o5 && (Array.isArray(o5) || (o5 = [o5]), e5 ? o5.forEach((r4) => {
      u4.includes(r4) || u4.push(r4);
    }) : n5[i4] = o5.slice())) : o5 && "object" == typeof o5 ? n5[i4] = f2(u4, o5, e5) : n5.hasOwnProperty(i4) && !t3.hasOwnProperty(i4) || (n5[i4] = o5), n5);
  }, n4 || {}) : n4;
}
function o2(r4, n4) {
  for (const t3 of Object.entries(r4)) if (n4 === t3[1]) return t3[0];
}
function l2(r4, n4) {
  return Object.values(r4).includes(n4);
}
...
function r2(r4, o5) {
  return o5 ? r4.replaceAll(e3, "object" == typeof o5 ? (e5, r5) => n2(t2(r5, o5)) : (t3, e5) => n2(o5(e5))) : r4;
}
function o3(t3, e5) {
...
var _i = class _i {
  ...
  _log(t3, r4, ...n4) {
    ...
    if ("always" !== r4 && !_i._throttlingDisabled) {
      const e5 = o4(n4), s5 = this._loggedMessages[t3].get(e5);
...
function o4(...e5) {
  ...
  return l3(JSON.stringify(e5, r4));
}
...
//# sourceMappingURL=chunk-QY7XKUIV.js.map
