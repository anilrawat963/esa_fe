...
var y = d2 = class extends b {
  ...
  assignFrom(o6) {
    this.color = o6.color.clone(), this.haloColor = o6.haloColor?.clone(), this.haloOpacity = o6.haloOpacity, this.fillOpacity = o6.fillOpacity, this.shadowColor = o6.shadowColor.clone(), this.shadowDifference = o6.shadowDifference, this.shadowOpacity = o6.shadowOpacity, this.haloBlur = o6.haloBlur, this.haloWidth = o6.haloWidth;
  }
};
...
function a5(t4, n4) {
  return null == n4 ? (t4?.destroy(), null) : ("single" === t4?.type && Array.isArray(n4) && (t4.destroy(), t4 = null), "multi" !== t4?.type || Array.isArray(n4) || (t4.destroy(), t4 = null), t4 || (t4 = Array.isArray(n4) ? new s3() : new d3()), Array.isArray(n4) ? "multi" === t4.type && t4.setHighlightOptions(n4) : "single" === t4.type && t4.setHighlightOptions(n4), t4);
}
...
//# sourceMappingURL=chunk-WKTI47FV.js.map
