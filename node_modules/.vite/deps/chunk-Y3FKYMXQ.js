...
async function i2(e, r, n2 = false) {
  if (!e || !r) return true;
  const a4 = e.replace(/\/FeatureServer/i, "/VersionManagementServer").replace(/\/\d*$/, ""), o3 = s.get(a4)?.entries();
  if (o3) {
    for (const [s2, i3] of o3) if (i3.name === r) {
      const e2 = !i3.stack?.hasForwardEdits();
      if (!e2 && n2) {
        const [{ deleteForwardEdits: e3 }, { default: r2 }] = await Promise.all([import("./deleteForwardEdits-SWVOZQIH.js"), import("./DeleteForwardEditsParameters-7QHAJ6BN.js")]), n3 = await e3(a4, s2, new r2({ sessionId: t, moment: i3.moment }));
...
//# sourceMappingURL=chunk-Y3FKYMXQ.js.map
