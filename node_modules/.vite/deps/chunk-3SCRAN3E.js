...
function I2(n2, t3, e2, o, r3 = f()) {
  const [l4, c2] = n2;
  return r3[0] = l4, r3[1] = c2, n2.length > 3 && (r3[3] = n2[3] ?? 0), "3d" !== e2?.type ? (r3[2] = t3.value, r3) : (r3[2] = I(e2, l4, c2, t3.value, o, t3.elevationInfo, U) ?? 0, r3);
}
var j2 = t(0, 0, 0, null);
...
//# sourceMappingURL=chunk-3SCRAN3E.js.map
