...
var f = () => i.getLogger("esri.views.webgl.BufferObject");
...
var o = class _o {
  ...
  static createPixelPack(t2, e = 35041, s) {
    const i2 = new _o(t2, 35051, e);
    return s && i2.setSize(s), i2;
  }
  static createPixelUnpack(t2, e = 35040, s) {
    return new _o(t2, 35052, e, s);
  }
  static createTransformFeedback(t2, e = 35044, s) {
    const i2 = new _o(t2, 35982, e);
    return i2.setSize(s), i2;
  }
  constructor(t2, e, s, i2) {
    this._context = t2, this.bufferType = e, this.usage = s, this._glName = null, this._size = -1, this._indexType = void 0, t2.instanceCounter.increment(O.BufferObject, this), this._glName = this._context.gl.createBuffer(), u(this._context.gl), i2 && this.setData(i2);
  }
  get glName() {
    return this._glName;
  }
  ...
  _setBufferData(t2, e = null) {
    ...
    null != e ? i2.bufferData(this.bufferType, e, this.usage) : i2.bufferData(this.bufferType, t2, this.usage), u(i2), this._isVAOAware && this._context.bindVAO(s);
  }
  setSubData(t2, e, s, i2) {
    if (!t2) return;
    const r = this._context.getBoundVAO();
    this._isVAOAware && this._context.bindVAO(null), this._context.bindBuffer(this);
    const { gl: u2 } = this._context;
    u2.bufferSubData(this.bufferType, e * t2.BYTES_PER_ELEMENT, t2, s, i2 - s), u(u2), this._isVAOAware && this._context.bindVAO(r);
  }
  getSubData(t2, e = 0, s, i2) {
    if (s < 0 || i2 < 0) return;
    const r = _(t2) ? t2.BYTES_PER_ELEMENT : 1;
    if (r * ((s ?? 0) + (i2 ?? 0)) > t2.byteLength) return;
    e + r * (i2 ?? 0) > this.usedMemory && f().warn("Potential problem getting subdata: requested data exceeds buffer size!");
    const n = this._context.gl;
    35982 === this.bufferType ? (this._context.bindBuffer(this, 35982), n.getBufferSubData(35982, e, t2, s, i2), this._context.unbindBuffer(35982)) : (this._context.bindBuffer(this, 36662), n.getBufferSubData(36662, e, t2, s, i2), this._context.unbindBuffer(36662));
  }
  async getSubDataAsync(t2, e = 0, s, i2) {
    await this._context.clientWaitAsync(), this.getSubData(t2, e, s, i2);
  }
};
function _(e) {
  return p(e);
...
//# sourceMappingURL=chunk-3RABUJDL.js.map
