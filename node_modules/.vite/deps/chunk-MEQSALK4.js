...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-MGJJOX4R.js"), import("./SpatialReference-HH3DAWOJ.js").then(({ injectPe: e2 }) => e2), n()]);
...
//# sourceMappingURL=chunk-MEQSALK4.js.map
