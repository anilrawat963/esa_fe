...
import {
  g
} from "./chunk-BUQC3CLV.js";
import {
  e,
  t
} from "./chunk-V2X4OKYI.js";
import {
  s
...
function _(t2, e4, s2) {
  const r3 = t2.length > e4.length ? t2 : e4, i2 = t2.length > e4.length ? e4 : t2, n2 = i2[i2.length - 1], c = n2?.scale ?? s2, o = n2?.effects ?? [];
...
//# sourceMappingURL=chunk-ALLCMCHO.js.map
